(function() {
    ...
    function createToggles() {
        ...
        themeButton.innerHTML = '<span id="theme-icon"><div class="icon-auto"></div></span>';
    ...
    function toggleLanguage() {
        ...
        if (document.body.style) {
            ...
            if (newLang === 'ar') {
                document.body.style.fontFamily = '"Noto Kufi Arabic", "Inter", Arial, sans-serif';
            } else {
    ...
    function initLanguage() {
        ...
        if (savedLang === 'ar') {
            ...
            document.querySelectorAll('.en-content, .en-btn').forEach(el => el.style.display = 'none');
            document.querySelectorAll('.ar-content, .ar-btn').forEach(el => el.style.display = '');
