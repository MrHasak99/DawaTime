...
class _AddMedicationsState extends State<AddMedications> {
  ...
  Future<void> _checkMedicationLimit() async {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextField(
                                      ...
                                      onChanged: (value) {
                                        if (_typeError && value.isNotEmpty) {
                                    ...
                                    ListTile(
                                      title: Text(
                                        ...
                                        style: Theme.of(
                                          ...
                                          fontWeight: FontWeight.bold,
                                          color: _timeError ? Colors.red : null,
                                        ),
                                      ),
                                      trailing: Icon(
                                    ...
                                    ListTile(
                                      ...
                                      trailing: Icon(
                                        ...
                                        color:
                                            _startDateError ? Colors.red : null,
                                      ),
                                      onTap: () async {
                                        final isDark =
                                            Theme.of(context).brightness ==
                                    ...
                                    _frequencyType == FrequencyType.daysOfWeek
                                        ? Column(
                                          children: [
                                            Text(
                                              AppLocalizations.of(
